...
def format_setting_section(master):
    global fileLabel_format, output_types, image_checkbox_var, pdf_checkbox_var, docx_checkbox_var, img_progress, pdf_progress, docx_progress
    ...
    docxFrame.pack(side=ctk.TOP, fill=ctk.BOTH, expand=True, padx=10, pady=10)

    pdfFrame = ctk.CTkFrame(
        format_output_section,
        fg_color="transparent"
    )
    pdfFrame.pack(side=ctk.TOP, fill=ctk.BOTH, expand=True, padx=10, pady=10)

    imgFrame = ctk.CTkFrame(
        format_output_section,
        fg_color="transparent"
    )
    imgFrame.pack(side=ctk.TOP, fill=ctk.BOTH, expand=True, padx=10, pady=10)
